...
// Font size parsers
#define parse_cpu_label_font_size(s) parse_float(s)
#define parse_gpu_label_font_size(s) parse_float(s)
#define parse_vram_label_font_size(s) parse_float(s)
#define parse_ram_label_font_size(s) parse_float(s)
#define parse_wine_label_font_size(s) parse_float(s)
#define parse_engine_label_font_size(s) parse_float(s)
#define parse_time_label_font_size(s) parse_float(s)
#define parse_fps_label_font_size(s) parse_float(s)
#define parse_resolution_label_font_size(s) parse_float(s)
#define parse_custom_text_font_size(s) parse_float(s)

// Color parsers
#define parse_cpu_label_color(s) parse_color(s)
#define parse_gpu_label_color(s) parse_color(s)
#define parse_vram_label_color(s) parse_color(s)
#define parse_ram_label_color(s) parse_color(s)
#define parse_wine_label_color(s) parse_color(s)
#define parse_engine_label_color(s) parse_color(s)
#define parse_time_label_color(s) parse_color(s)
#define parse_fps_label_color(s) parse_color(s)
#define parse_resolution_label_color(s) parse_color(s)
#define parse_custom_text_color(s) parse_color(s)

// Title parsers
#define parse_title_text(s) parse_str(s)
#define parse_title_font_size(s) parse_float(s)
#define parse_title_color(s) parse_color(s)
#define parse_title_position(s) parse_str(s)

// CPU core filtering
#define parse_cpu_cores(s) parse_str(s)
#define parse_core_p_font_size(s) parse_float(s)
#define parse_core_p_color(s) parse_color(s)
#define parse_core_e_font_size(s) parse_float(s)
#define parse_core_e_color(s) parse_color(s)

// Custom label text
#define parse_cpu_label_text(s) parse_str(s)
#define parse_gpu_label_text(s) parse_str(s)
#define parse_vram_label_text(s) parse_str(s)
#define parse_ram_label_text(s) parse_str(s)
...
static void set_param_defaults(struct overlay_params *params){
   ...
   // Component font sizes default to 0 (use default font_size)
   params->cpu_label_font_size = 0;
   params->gpu_label_font_size = 0;
   params->vram_label_font_size = 0;
   params->ram_label_font_size = 0;
   params->wine_label_font_size = 0;
   params->engine_label_font_size = 0;
   params->time_label_font_size = 0;
   params->fps_label_font_size = 0;
   params->resolution_label_font_size = 0;
   params->custom_text_font_size = 0;

   // Component colors default to their base colors
   params->cpu_label_color = params->cpu_color;
   params->gpu_label_color = params->gpu_color;
   params->vram_label_color = params->vram_color;
   params->ram_label_color = params->ram_color;
   params->wine_label_color = params->wine_color;
   params->engine_label_color = params->engine_color;
   params->time_label_color = params->text_color;
   params->fps_label_color = params->engine_color;
   params->resolution_label_color = params->engine_color;
   params->custom_text_color = params->text_color;

   // Title defaults
   params->title_text = "";
   params->title_font_size = 0;
   params->title_color = params->text_color;
   params->title_position = "";

   // CPU core filtering defaults
   params->cpu_cores = "";
   ...
   // Custom label text defaults
   params->cpu_label_text = "";
   params->gpu_label_text = "";
   params->vram_label_text = "";
   params->ram_label_text = "";
}
                  ...
                  const char *env, bool use_existing_preset)
{
   ...
   *params = {};
   ...
   std::array<unsigned *, 37> colors = {
      ...
      &params->cpu_label_color,
      &params->gpu_label_color,
      &params->vram_label_color,
      &params->ram_label_color,
      &params->wine_label_color,
      &params->engine_label_color,
      &params->time_label_color,
      &params->fps_label_color,
      &params->resolution_label_color,
   ...
   params->font_params_hash = get_hash(params->font_size,
                                 ...
                                 params->cpu_label_font_size,
                                 params->gpu_label_font_size,
                                 params->vram_label_font_size,
                                 params->ram_label_font_size,
                                 params->title_font_size,
                                 params->custom_text_font_size,
   ...
   // Apply CPU core filter if specified
   if (!params->cpu_cores.empty()) {
      cpuStats.SetCoreFilter(params->cpu_cores);
      SPDLOG_DEBUG("CPU core filter set: {}", params->cpu_cores);
   }
